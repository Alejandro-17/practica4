...
int main(){
    ...
    cout<<"1. Mostrar red original."<<endl<<"2. Mostrar red con conexiones mas bajas."<<endl<<"3. Agregar enrutador de la red."<<endl<<"4. Remover enrutador de la red."<<endl<<"5. Costo de envio de un router a otro."<<endl;
    cout<<"6. Salir"<<endl;
    cout<<"Opcion: "; cin>>opcion;
    cout<<opcion;
    cout<<endl;

    //***Red inicial***   -> Muestra la red sin los costos más bajos. Definida originalmente
    if (opcion==1){
